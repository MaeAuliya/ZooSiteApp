class Models {
  ...
  static List<String> auliyaAnimalDesc = [
    ...
    "Aves adalah kelas hewan bertulang belakang (vertebrata) yang mencakup seluruh jenis burung. Mereka memiliki bulu, paruh tanpa gigi, dan kemampuan bertelur dengan cangkang keras. Sebagian besar burung dapat terbang, meski ada juga yang tidak seperti burung unta. Aves memainkan peran penting dalam ekosistem sebagai penyerbuk, pengendali hama, dan penyebar biji.",
